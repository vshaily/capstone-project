      ...
      tabsetPanel(type = "tab",
                  ...
                  tabPanel("Additional Information", 
                         p(style = "text-align: justify; font-size = 50px; color: blue",
                           "It is important to stay informed on the numerous risks associated with exposure to certain pollutants."),
                         p(style = "text-align: justify; font-size = 30px; color: green",
                           "Benzene:"),
                         p(style = "text-align: justify; font-size = 16px",
                         ...
                         p(style = "text-align: justify; font-size = 16px",
                           "What it does to you:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Benzene carries both acute and long term effects. Acute benzene poisoning can come in the form of exposure to 
                           liquid or high levels of benzene gas in the automotive or manafacturing industries. {3} This can cause issues
                           ranging from vomiting, dizziness, unconsciousness and even death. Long term exposure can harm bone marrow leading
                           to anemia. It can harm the immune system, increasing the likelihood and potency of subsequent infections. 
                           Additionally, the department of health and human sciences has determined that benzene causes cancer in humans, 
                           particularly leukemia{2}. Women may also experience negative effects when consistently breathing high doses of benzene
                           while pregnant. {3}"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Significant Concentrations:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "The significant concentration for benzene is roughly 0.009 ppb {4}"),
                         p(style = "text-align: justify; font-size = 16px",
                           "What to do:"),
                         ("If you are in an area with an increased vapor concentration of benzene, the main intervention is to leave the area 
                         and avoid further exposure with the gas.{1}"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Vulnerable Populations:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Families of smokers."),
                         p(style = "text-align: justify; font-size = 16px",  
                         "Individuals in industries that involves benzene in their processes, or that produce the substance.{3}"),
                         p(style = "text-align: justify; font-size = 30px; color: green",
                           "Ozone:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "It is a gas consisting of 3 oxygen molecules, mainly found in the upper atmosphere and 
                           the ground. Ground level ozone is usually caused by factories and is more present in the summer months. {5,6}"),
                         p(style = "text-align: justify; font-size = 16px",
                           "What it does to you:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "It can cause significant lung decrements when present in high volumes. {7}
                           Additionally, it is shown to correspond heavily to emergency department visits for asthma, COPD, and other
                           respiratory comorbidities, showing an irritative effect on the pulmonary tissue.
                           It has also been shown to have a negative impact on the cardiovascular system, resulting in morbidity which
                         ...
                         p(style = "text-align: justify; font-size = 30px; color: green",
                           "Carbon Monoxide:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "It is a gas that results from the incomplete combustion of fuel.
                           Examples include a vehicle or a wood stove.{13}"),
                         p(style = "text-align: justify; font-size = 16px",
                           "What it does to you:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "It can deprive the brain of blood and oxygen, leading to serious side-effects.
                           Indoors, it can even lead to death.{12,13,15,16}"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Significant Concentrations:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "A significant concentration is 50 ppm."),
                         p(style = "text-align: justify; font-size = 16px",
                           "What to do:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Avoid going outside.{1,3}"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Vulnerable Populations:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Individuals with heart conditions{17}"),
                         p(style = "text-align: justify; font-size = 30px; color: green",
                           "Nitrogen Dioxide:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Comes from burning fuel, including power plants and cars. {18}"),
                         p(style = "text-align: justify; font-size = 16px",
                           "What it does to you:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Breathing in this pollutant is shown to cause pulmonary system 
                           irritation.{19}"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Significant Concentrations:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "If your annual average exposure is greater than 53 ppb, that is significant{10}"),
                         p(style = "text-align: justify; font-size = 16px",
                           "What to do:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Use an exhaust ventilation at the source site of the significant concentration, and wear
                           work gear to protect yourself"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Vulnerable Populations:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Individuals with asthma, children, and the elderly{18,19}"),
                         p(style = "text-align: justify; font-size = 30px; color: green",
                           "Sulfur Dioxide(represents all sulfur oxides):"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Comes from power plants burning fossil fuels{20}"),
                         p(style = "text-align: justify; font-size = 16px",
                           "What it does to you:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Short term exposure can make impact an individual's
                           ability to breathe{20}"),
                         p(style = "text-align: justify; font-size = 16px",
                           "Significant Concentrations:"),
                         p(style = "text-align: justify; font-size = 16px",
                           "If your annual average exposure is greater than 0.5 ppm in a three hour time-span, that is significant{10}"),
                         p(style = "text-align: justify; font-size = 16px",
                           "What to do:"),
                         p(style = "text-align: justify; font-size = 16px",
